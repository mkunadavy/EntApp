...
public class FootballActivityTwo extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.football_activity2, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_epl) {

        } else if (id == R.id.nav_bundesliga) {

        } else if (id == R.id.nav_uefa) {
